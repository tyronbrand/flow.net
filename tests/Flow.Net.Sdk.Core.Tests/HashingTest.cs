namespace Flow.Net.Sdk.Tests
{
    public class HashingTest
    {
        ...
        public void TestSHA3_256Hashing()
        {
            ...
            var output = Core.Crypto.Hasher.CalculateHash(input.HexToBytes(), HashAlgo.SHA3_256);
            Assert.Equal(expectedOutput, output.BytesToHex(true));
        }
        ...
        public void TestSHA2_256Hashing()
        {
            ...
            var output = Core.Crypto.Hasher.CalculateHash(input.HexToBytes(), HashAlgo.SHA2_256);
            Assert.Equal(expectedOutput, output.BytesToHex(true));
        }
    }
}
