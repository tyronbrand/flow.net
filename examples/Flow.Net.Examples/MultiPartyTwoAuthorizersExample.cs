...
namespace Flow.Net.Examples
{
    public class MultiPartyTwoAuthorizersExample : ExampleBase
    {
        public static async Task RunAsync()
        {
            ...
            ColorConsole.WriteWrappedHeader("Multi party two authorizers example", headerColor: ConsoleColor.Yellow, dashColor: ConsoleColor.Yellow);
...
transaction { 
	prepare(signer1: AuthAccount, signer2: AuthAccount) { 
		...
		log(signer2.address)
            ...
            ColorConsole.WriteWrappedHeader("End multi party two authorizers example", headerColor: ConsoleColor.Yellow, dashColor: ConsoleColor.Gray);
        }
    }
}
