...
namespace Flow.Net.Examples
{
    ...
    public static class ColorConsole
    {
        ...
        public static void WriteWrappedSubHeader(string headerText,
                                                char wrapperChar = '-',
                                                ConsoleColor headerColor = ConsoleColor.DarkMagenta,
                                                ConsoleColor dashColor = ConsoleColor.DarkMagenta)
        {
