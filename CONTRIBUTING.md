# Contributing to the Flow .Net SDK

The following is a set of guidelines for contributing to the Flow .Net SDK.
...
- **Provide specific examples to demonstrate the steps**.
  Include copy/paste-able snippets which you use in those examples,
...
Please follow the [style guides](#style-guides) to have your contribution considered by the maintainers.
