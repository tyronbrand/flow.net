...
namespace Flow.Net.Sdk.Models
{
    public static class FlowTransactionExtensions
    {
        ...
        public static FlowTransaction AddPayloadSignature(this FlowTransaction flowTransaction, FlowAddress address, uint keyId, ISigner signer)
        {
        ...
        public static FlowTransaction AddEnvelopeSignature(this FlowTransaction flowTransaction, FlowAddress address, uint keyId, ISigner signer)
        {
